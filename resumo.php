        ...
        <div class="page-header">
          <div class="row">
            ...
            <div class="inline" style="
              ...
              <input id="plano" class="form-control" style="height: calc(2rem + 2px) !important;background-color: #b3b3b3 !important; text-align: center;margin-left: 5%;" value="<?php echo $_SESSION['plano'] ?>" readonly />
            </div>
          </div>
        </div>
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30" style='
          ...
          <form method="post" action="processa.php">
            ...
            if ($_SESSION['plano'] == 'UNIDENTISVIPBOLETO' && $_SESSION['uf'] == 'PB' && $cont == 0) {
              ...
              $_SESSION['plano'] == 'UNIDENTISVIPBOLETO' && $cont >= 1 &&
              $_SESSION['uf'] == 'PB'
            ) {
              $preco = 35;
            } elseif (
