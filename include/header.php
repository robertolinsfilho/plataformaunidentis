		...
		<div style="background-color: #284ebf;height:130%;" class="header-right">
			...
			<div style=" color:white;margin-top: 0;"  class="user-info-dropdown">
				...
				<div  style="color:white;position:absolute; top: 1.5rem; right: .75rem;" class="dropdown">
					<a style=" color:white;background-color: #4177d0;border-radius: 8px; padding: 7px;"class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span  style="color:white;"class="user-icon"><i style="color:white;line-height: 1.75rem;font-size: 14px;"class="fa fa-user-o"></i></span>
						<span   style="color:white;font-size: 14px;"class="user-name"><?= $row_usuario2['vendedor']?></span>
