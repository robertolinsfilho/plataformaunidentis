												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<a href="fotos/<?php echo $row_usuario7['rgfrente'] ?>" target="_blank">
															<div class='wBackImg' style='background-image: url("fotos/<?php echo $row_usuario7['rgfrente'] ?>")'></div>
														</a>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<a href="fotos/<?php echo $row_usuario7['rgverso'] ?>" target="_blank">
															<div class='wBackImg' style='background-image: url("fotos/<?php echo $row_usuario7['rgverso'] ?>")'></div>
														</a>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<a href="fotos/<?php echo $row_usuario7['cpf'] ?>" target="_blank">
															<div class='wBackImg' style='background-image: url("fotos/<?php echo $row_usuario7['cpf'] ?>");'></div>
														</a>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<a href="fotos/<?php echo $row_usuario7['compresidencia'] ?>" target="_blank">
															<div class='wBackImg' style='background-image: url("fotos/<?php echo $row_usuario7['compresidencia'] ?>");'></div>
														</a>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<a href="fotos/<?php echo $row_usuario7['cartao'] ?>" target="_blank">
																<div class='wBackImg' style='background-image: url("fotos/<?php echo $row_usuario7['cartao'] ?>")'></div>
															</a>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<a href="fotos/<?php echo $row_usuario7['outro'] ?>" target="_blank">
															<div class='wBackImg' style='background-image: url("fotos/<?php echo $row_usuario7['outro'] ?>")'></div>
														</a>
