...
$result_usuario = "SELECT * from dadospessoais where status = 'Pag Pendente' and pagamento = 0  ";
$resultado_usuario = mysqli_query($conexao, $result_usuario);
}else{
	$result_usuario = "SELECT * from dadospessoais where status = 'Pag Pendente' and pagamento = 0 and vendedor = '$_SESSION[usuario]' or '$_SESSION[usuario]' = 'admin'  ";
	$resultado_usuario = mysqli_query($conexao, $result_usuario);
}
						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Pagamento Pendente</li>
								</ol>
							</nav>
						</div>
