...
error_reporting(0);
    ...
    $result_usuario = "SELECT COUNT(id) AS total FROM dadospessoais where status = 'Indeferido' and corretora =  '$_SESSION[corretora]'" ;
    $resultado_usuario = mysqli_query($conexao, $result_usuario);
    $row_usuario = mysqli_fetch_assoc($resultado_usuario);
    $result_usuario1 = "SELECT COUNT(id) AS total FROM dadospessoais where status = 'Em Averbação' and corretora = '$_SESSION[corretora]' ";
    $resultado_usuario1 = mysqli_query($conexao, $result_usuario1);
    $row_usuario1 = mysqli_fetch_assoc($resultado_usuario1);
    $result_usuario2 = "SELECT COUNT(id) AS total FROM dadospessoais where status = 'Em Analise' and corretora = '$_SESSION[corretora]' ";
    $resultado_usuario2 = mysqli_query($conexao, $result_usuario2);
    $row_usuario22 = mysqli_fetch_assoc($resultado_usuario2);
    $result_usuario3 = "SELECT COUNT(id) AS total FROM dadospessoais where status = 'Cancelado' and corretora =  '$_SESSION[corretora]'";
    $resultado_usuario3 = mysqli_query($conexao, $result_usuario3);
    $row_usuario3 = mysqli_fetch_assoc($resultado_usuario3);
    $result_usuario4 = "SELECT COUNT(id) AS total FROM dadospessoais where status = 'Implantadas' and corretora = '$_SESSION[corretora]'";
    $resultado_usuario4 = mysqli_query($conexao, $result_usuario4);
    $row_usuario4 = mysqli_fetch_assoc($resultado_usuario4);
    $result_usuario6 = "SELECT COUNT(id) AS total FROM dadospessoais where status = 'Pag Pendente' and corretora = '$_SESSION[corretora]' ";
    $resultado_usuario6 = mysqli_query($conexao, $result_usuario6);
    $row_usuario6 = mysqli_fetch_assoc($resultado_usuario6);
    $result_usuario7 = "SELECT COUNT(id) AS total FROM dadospessoais where status = 'Nova'  and corretora = '$_SESSION[corretora]'";
    $resultado_usuario7 = mysqli_query($conexao, $result_usuario7);
    $row_usuario7 = mysqli_fetch_assoc($resultado_usuario7);
    $result_usuario5 = "SELECT COUNT(id) AS total FROM dependentes where ativo = '1' and corretora = '$_SESSION[corretora]'";
