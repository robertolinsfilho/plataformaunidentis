          ...
          <form action="updatedependente" method="POST">
            <div class="row">
              ...
              <div class="col">
                ...
                <label style="font-family:'Poppins', sans-serif;" for="LabelNome">CPF:</label>
                <input type="text" name="cpf" id="cpf" class="form-control" value="<?= $row_usuario['cpf'] ?>" placeholder="CPF">
              </div>
              <div class="col">
                <label style="font-family:'Poppins', sans-serif;  " for="LabelNome">Parentesco</label>
                <select name="parentesco" placeholder="selecione" class="form-control" required>
            ...
            <div class="row">
              <div class="col">
                <label style="font-family:'Poppins', sans-serif;  " for="LabelNome">Nome Completo</label>
                <input type="text" name="nome" class="form-control" minlength="10" placeholder="Nome Completo" value="<?= $row_usuario['nome'] ?>" required>
              </div>
              <div class="col">
                <label style="font-family:'Poppins', sans-serif;  " for="LabelNome">CPF Titular:</label>
                <input type="text" name="cpf_titular" value="<?php echo $_SESSION['cpf'] ?>" class="form-control" placeholder="Nome Completo" readonly>
              ...
              <div class="col">
                <label style="font-family:'Poppins', sans-serif;  " for="LabelNome">CNS-CARTAO SUS </label>
                <input type="text" name="cns" class="form-control" minlength="15" maxlength="15" value="<?= $row_usuario['cns'] ?>" placeholder="Numero do cartão">
              </div>
              <br>
            </div>
            <br>
            <div class="row">
              ...
              <div class="col">
                <label style="font-family:'Poppins', sans-serif;  " for="LabelNome">Estado Civil:</label>
                <select class="form-control" placeholder="selecione" name="estadocivil" value="<?= $row_usuario['estadocivil'] ?>" required>
              </div>
            ...
            <div class="col">
              <label style="font-family:'Poppins', sans-serif;  " for="LabelNome">Data Nascimento</label>
              <input type="text" name="datas" id="data" class="form-control" placeholder="DD/MM/ANO" value="<?= $row_usuario['datas'] ?>" required>
            </div>
            <div class="col">
              <label style="font-family:'Poppins', sans-serif;  " for="LabelNome">Nome da Mãe</label>
              <input type="text" name="mae" class="form-control" minlenght="10" placeholder="Nome da Mae" value="<?= $row_usuario['mae'] ?>" required>
            </div>
        </div>
        <br>
      </div>
